...
class CafeForm(FlaskForm):
    ...
    coffee_rating = SelectField('Coffee Rating', validators=[DataRequired()],
                                choices=[("☕️"), ("☕️☕️️"), ("☕️☕️☕️"), ("☕️☕️☕️☕️"), ("☕️☕️☕️☕️☕️")])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open('cafe-data.csv', 'a', newline='') as file:
            file.write(f"{form.data['cafe']},{form.data['location']},{form.data['open_time']},"
                            f"{form.data['close_time']},{form.data['coffee_rating']},{form.data['wifi_rating']},"
